...
export function AdminLayout() {
  ...
  const navItems = [
    ...
    { icon: <ClipboardCheck size={20} />, label: "Reports", path: "/admin/reports" },
  ...
  const activeClass =
    "flex items-center gap-3 px-3 py-2 rounded-lg bg-[#0B1F8C] text-white";
  const inactiveClass =
      ...
      <aside className="hidden md:flex flex-col w-64 bg-white border-r border-gray-200">
        ...
        <div className="p-4 border-t border-gray-200">
          <button
            ...
            className="flex items-center gap-3 px-3 py-2 w-full rounded-lg text-gray-700 hover:bg-gray-100"
          >
            <LogOut size={20} />
            <span>Log Out</span>
          </button>
